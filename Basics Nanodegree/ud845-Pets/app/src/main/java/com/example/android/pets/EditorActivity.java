...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    //Insert Pet Into DataBase Using when user set save button
    private void savePetIntoDataBase() {
        //Get Pet Attribute
        ...
        //Check if wight is empty set zero as default value
        int petWeight = 0;
        ...
        //Save Attribute on ContentValues
        values.put(PetEntry.COLUMN_PET_NAME, nameString);
        values.put(PetEntry.COLUMN_PET_BREED, breedString);
        values.put(PetEntry.COLUMN_PET_GENDER, mGender);
        values.put(PetEntry.COLUMN_PET_WEIGHT, petWeight);

        //Push The Pet Information To SQLite DataBase
    ...
    private void updatePetIntoDataBase() {
        //That Mean Save pet method will call not this method
        if (currentUri == null) {
