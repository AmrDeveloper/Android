...
public class AddTaskActivity extends AppCompatActivity {
    ...
    public void onClickAddTask(View view) {
        // Not yet implemented
        final EditText descriptionEditText = (EditText) findViewById(R.id.editTextTaskDescription);
        ...
        if(uri != null){
            Toast.makeText(getBaseContext(), "Task Add Done" + uri.toString(), Toast.LENGTH_SHORT).show();
        }
